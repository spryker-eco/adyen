...
use SprykerEco\Zed\Adyen\Business\Handler\Redirect\KlarnaInvoiceRedirectHandler;
...
use SprykerEco\Zed\Adyen\Business\Hook\Mapper\MakePayment\AliPayMapper;
...
use SprykerEco\Zed\Adyen\Business\Hook\Saver\MakePayment\AliPaySaver;
...
use SprykerEco\Zed\Adyen\Business\Payment\Converter\AdyenPaymentMethodFilterConverter;
...
class AdyenBusinessFactory extends AbstractBusinessFactory
{
    ...
    /**
     * @return \SprykerEco\Zed\Adyen\Business\Payment\Converter\AdyenPaymentMethodFilterConverterInterface
     */
    public function createPaymentMethodsFilterConverter(): AdyenPaymentMethodFilterConverterInterface
    {
        return new AdyenPaymentMethodFilterConverter($this->getConfig());
    }
     ...
     * @return \SprykerEco\Zed\Adyen\Business\Hook\Mapper\MakePayment\AdyenMapperInterface
     */
    public function createIdealMakePaymentMapper(): AdyenMapperInterface
    {
        return new IdealMapper($this->getConfig());
    }
     ...
     * @return \SprykerEco\Zed\Adyen\Business\Hook\Mapper\MakePayment\AdyenMapperInterface
     */
    public function createAliPayMakePaymentMapper(): AdyenMapperInterface
    {
        return new AliPayMapper($this->getConfig());
    }
