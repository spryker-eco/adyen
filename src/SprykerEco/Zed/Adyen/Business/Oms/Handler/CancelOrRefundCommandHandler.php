...
class CancelOrRefundCommandHandler extends AbstractCommandHandler implements AdyenCommandHandlerInterface
{
    /**
    ...
    {
        return $this->adyenApiFacade->performCancelOrRefundApiCall($request);
    }
}
