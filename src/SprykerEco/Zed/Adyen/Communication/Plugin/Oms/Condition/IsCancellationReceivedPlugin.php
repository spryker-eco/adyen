 ...
 */
class IsCancellationReceivedPlugin extends AbstractPlugin implements ConditionInterface
{
    /**
     * {@inheritdoc}
     *
    ...
    public function check(SpySalesOrderItem $orderItem): bool
    {
        ...
        return $adyenOrderItem->getStatus() === $this->getConfig()->getOmsStatusCancellationPending();
    }
}
