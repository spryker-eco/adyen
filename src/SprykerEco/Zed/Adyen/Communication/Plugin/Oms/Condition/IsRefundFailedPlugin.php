 ...
 */
class IsRefundFailedPlugin extends AbstractPlugin implements ConditionInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    public function check(SpySalesOrderItem $orderItem): bool
    {
        ...
        return $adyenOrderItem->getStatus() === $this->getConfig()->getOmsStatusRefundFailed();
    }
}
